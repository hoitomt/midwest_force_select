<?php
  ...
  $stmt = $pdo->prepare("INSERT INTO camp_registrations (camp_name, participant_name, parent_name, email_address, mailing_address, mailing_city, mailing_state, mailing_zip_code, graduation_year, session) VALUES (:camp_name, :participant_name, :parent_name, :email_address, :mailing_address, :mailing_city, :mailing_state, :mailing_zip_code, :graduation_year, :session)");
  ...
  $stmt->bindParam(':session', $form_data['session']);
